...
public class Enemy_Mage : Enemy, ICounterable
{
    ...
    protected override void Awake()
    {
        ...
        animator.SetBool("hasStunRecovery", hasRecoveryAnimation);
    ...
    {
        bool detectedWall = Physics2D.Raycast(behindCollsionCheck.position, Vector2.right * -facingDirection, 1.5f, groundLayer);
        bool noGround = Physics2D.Raycast(behindCollsionCheck.position, Vector2.down, 1.5f, groundLayer) == false;
    ...
    protected override void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(behindCollsionCheck.position,
            new Vector3(behindCollsionCheck.position.x + (1.5f * -facingDirection), behindCollsionCheck.position.y));
